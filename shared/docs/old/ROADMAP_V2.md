...
> **⚠️ SUPERSEDED 2026-04-17 by [`ROADMAP_V3.md`](ROADMAP_V3.md).**
> Keep this file on disk for history. Any new work, decisions, or phase
> updates go into V3. Agents starting a new session should read V3 first.
