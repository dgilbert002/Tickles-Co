...
function showAccountModal(id){
  ...
  modal.innerHTML='<div class="modal-head"><h2>'+(id?'Edit':'Add')+' Exchange Account</h2><button class="drawer-close">&times;</button></div><div class="modal-body"><div class="settings-label">Exchange</div><select class="select wide" id="acct-exch"><option value="bybit">Bybit</option><option value="blofin">BloFin</option><option value="bitget">Bitget</option><option value="toobit">Toobit</option></select><div class="settings-label">Account Name</div><input class="input wide" id="acct-name" placeholder="e.g. DEMO"><div class="settings-label">Description</div><input class="input wide" id="acct-desc" placeholder="Label"><div class="settings-label">Account Type</div><select class="select wide" id="acct-type"><option value="demo">Demo</option><option value="live">Live</option></select><div style="margin:16px 0;padding:12px;border:1px solid var(--border);border-radius:8px"><div class="settings-label">Margin Mode</div><select class="select wide" id="acct-margin-mode"><option value="cross">Cross margin</option><option value="isolated">Isolated margin</option></select><div class="settings-label">Max account margin usage (%)</div><input class="input wide" id="acct-margin-usage" type="number" min="0" max="100" step="1" value="100"><div class="secondary" style="margin-top:6px;font-size:12px">0% = no new positions. 100% = use full equity. Caps both positions+open orders.</div></div><div class="settings-label">API Key</div><input class="input wide mono" id="acct-key" placeholder="API key"><div class="settings-label">API Secret</div><input class="input wide mono" id="acct-secret" placeholder="API secret" type="password"><div class="settings-label">API Passphrase</div><input class="input wide mono" id="acct-pass" placeholder="Optional" type="password"></div><div class="modal-foot"><button class="pill-btn" id="acct-cancel">Cancel</button><button class="pill-btn" id="acct-save" style="background:var(--purple);color:#fff">Save</button></div>';
