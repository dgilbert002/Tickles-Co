"""
shared.copy.service — orchestrates the copy-trader.
...
from shared.copy.protocol import CopySource, CopyTrade, SourceFill
from shared.copy.sources import BaseCopySource
