...
CREATE TABLE public.media_items (
    ...
    CONSTRAINT media_items_processing_status_check CHECK (((processing_status)::text = ANY ((ARRAY['pending'::character varying, 'downloading'::character varying, 'downloaded'::character varying, 'analyzing'::character varying, 'analyzed'::character varying, 'discarded'::character varying, 'failed'::character varying, 'skipped'::character varying, 'skipped_vision_unavailable'::character varying, 'skipped_not_chart'::character varying, 'skipped_unsupported_media'::character varying, 'skipped_no_content'::character varying, 'skipped_stale'::character varying])::text[])))
);
